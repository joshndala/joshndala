...
|---------|----------|------------------|-------------|-------|
| CoachDeck (Formerly VAR Vendetta) | May 2025 | Next.js (React), Typescript, Cohere AI (Embed, Command), Web Speech API, FAISS, PostgreSQL (Supabase) | An AI-powered sports coaching platform that automatically logs, categorizes, and analyzes real-time game events using voice transcription, player detection, and intelligent event separation to provide coaches with detailed session insights. | [View Github](https://github.com/joshndala/var-vendetta) |
